    ...
    <main>
            ...
            <div class="slider-active">
                ...
                <div class="single-slider position-relative hero-overly slider-height2  d-flex align-items-center"
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="hero-caption hero-caption2">
                                    <img src="{{asset('assets/img/hero/hero-icon.png')}}" alt="" data-animation="zoomIn"
                                         data-delay="1s">
                                    <h2 data-animation="fadeInLeft" data-delay=".4s">контакт</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="hero-img hero-img2">
                        <img src="{{asset('assets/img/hero/h2_hero2.png')}}" alt="" data-animation="fadeInRight"
        ...
        <section class="contact-section">
            <div class="container">
                        ...
                        <div
                            ...
                            <div class="gm-style" style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px;">
                                ...
                                <div
                                    ...
                                    <div style="padding: 0px 0px 10px; font-size: 16px; box-sizing: border-box;">Данные карты
                                    </div>
                                    <div style="font-size: 13px;">Данные карты ©2019 Google</div>
                                ...
                                <div class="gmnoprint"
                                    ...
                                    <div draggable="false" class="gm-style-cc"
                                        ...
                                        <div
                                            ...
                                            <a style="text-decoration: none; cursor: pointer; display: none;">Данные карты</a><span>Данные карты ©2019 Google</span></div>
                                    </div>
                                </div>
                                ...
                                <div draggable="false" class="gm-style-cc"
                                    ...
                                    <div
                                        ...
                                        <a target="_blank" rel="noopener"
                                           ...
                                           style="font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(68, 68, 68); text-decoration: none; position: relative;">Сообщите
                                            ошибку карты</a></div>
                                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Свяжитесь</h2>
                    </div>
                    <div class="col-lg-8">
                        ...
                        <form class="form-contact contact_form" action="{{route('client.store')}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" id="message" cols="30"
                                                  ...
                                                  onblur="this.placeholder = 'Сообщение вывода'"
                                                  placeholder="Сообщение вывода"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="email" id="email" type="email"
                                               onfocus="this.placeholder = ''"
                                               onblur="this.placeholder = 'Введите ваше email'" placeholder="Email">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="subject" id="subject" type="text"
                                               onfocus="this.placeholder = ''"
                                               onblur="this.placeholder = 'Введите предмет'" placeholder="Введите предмет">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>ТУИТ Ургенчского филиала,группы 915-21 .</h3>
                                <p>Студента: Рахимов Азамат</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                            <div class="media-body">
                                <h3>+99 894 081 00 48</h3>
                                <p>Понедельник в Суббота 8:30 - на 12:50 до обеда</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>azamatrahimov80@gmail.com</h3>
                                <p>Пошлите нам ваш запрос в любуе время!</p>
                            </div>
                        </div>
                    </div>
                </div>
